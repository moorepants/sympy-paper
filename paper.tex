...
\abstract{
  Symbolic based computer aided algebra systems (CAS) play an important role in
  scientific computing with the earliest packages dating back into the 1970s.
  ...
  developers in a bazaar open source development model.
  ...
  This paper will give an overview of what SymPy is and what it offers with
  respect to similar software.
  We will highlight the benefit of SymPy's community model and show how this
  meets instantaneous computing needs of our users.
  To close, we will present why and how SymPy is useful to researchers,
  educators, and the scientific software industry with examples of it's use in
  these fields.
  The supplementary materials will further outline the details of the design
  decisions and algorithms that make SymPy what it is today.
}
